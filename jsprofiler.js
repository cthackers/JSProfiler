var JSProfile = (function() {
	var profiles = {},
		...
		css = '#profileStats {border:1px solid rgba(0, 0, 0, 0.5);position:absolute;zindex: 1000;width: 300px;height:302px;box-shadow: 0px 1px 2px 2px rgba(170, 187, 204, 0.3);-webkit-user-select: none;position:absolute; right:10px; bottom:10px;}#profileStats h1 \
		{margin:0; padding:3px 10px;font-family:Verdana;font-size:10px;height:13px;cursor:default;background: #efefef;}#profileStats #gc {background: url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUg\
		...
		#profileStats #profileBody {height: 227px;padding:2px;font-size:9px;font-family: Arial;}#profileStats #profileBody tr th span.up {background: url("data:image/gif;base64,R0lGODlhBgADAIAAAAAAA\
		...
		#profileBody tr th {background: #efefef;padding:2px 0;-webkit-user-select: none;cursor:pointer;}#profileStats #profileBody tr td:first-child {text-align:left}#profileStats #profileBody tbody tr td {bor\
		...
		order:1px inset;float:right;cursor:default;width:80px;height:38px;padding:3px 0px 0px 5px;font-size:9px;font-family: Arial;}';
	...
	function showStats() {
		...
		for (var i = 0; i < mem.length; i++) {
			var x = ((i + 1) * graph.resolution) / mem.length;
